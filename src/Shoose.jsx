...
export default function Shoose({ ajouterAuPanier }) {
  ...
  return (
    <>
      <div className='top'>
        <img id='img1' src={lowbrun} alt="dunk low brun" onClick={() => setFiltre("low")} />
        <img id='img2' src={highbrun1} alt="air-jordan-high-brun" onClick={() => setFiltre("high")} />
      </div>
